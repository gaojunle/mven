...
//制造验证码图片
function makeCapcha() {
    var img = new BMP24(160, 36);
    img.drawCircle(rand(0, 160), rand(0, 40), rand(10, 40), rand(0, 0xffffff));
    //边框
    ...
    for (var i = 0; i < str.length; i++) {
        ...
        y = 8 + rand(-10, 10);
        img.drawChar(str[i], x, y, f, rand(0xdddddd, 0xffffff));
        x += f.w + rand(2, 8);
    }
    return img;
}
